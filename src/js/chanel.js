...
Component.entryPoint = function(){
    ...
    (function(){
        ...
        YAHOO.extend(ChanelEditorPanel, Brick.widget.Dialog, {
            el: function(name){
                return Dom.get(this._TId['editorchanel'][name]);
            },
            elv: function(name){
            ...
            onClick: function(el){
                ...
                var numid = el.id.replace(prefix, "");
                switch (prefix) {
                    case (this._TId['edchrow']['remove'] + '-'):
                        this.removeSource(numid);
                        return true;
                }
                return false;
            },
    ...
    (function(){
        ...
        YAHOO.extend(SourceEditorPanel, Brick.widget.Dialog, {
            el: function(name){
                return Dom.get(this._TId['editorsource'][name]);
            },
            elv: function(name){
                return Brick.util.Form.getValue(this.el(name));
            },
